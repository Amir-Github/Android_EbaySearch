...
public class RestClient {
    private static final int MAX_URI_LENGTH_FOR_GET = 1024;
     ...
     */
    public static InputStream call(String serviceUrl, Map parameters, Map filters) throws IOException, RestException {
        StringBuffer urlString = new StringBuffer(serviceUrl);
        
        String query = RestClient.buildQueryString(parameters);
        if(filters.size() > 0)
          query += "&"+RestClient.buildQueryString(filters);     /////Attach all filters
